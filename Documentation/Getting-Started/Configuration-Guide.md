...
switchover uses to block writes to the master. This setting cannot be modified
during runtime.
...
used when loading the users from the backend servers. When enabled, creates a
union of all the users and grants on all the servers.
