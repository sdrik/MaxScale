...
int main(int argc, char* argv[])
{
    ...
    Test->try_query(Test->maxscales->conn_rwsplit[0], "CREATE USER 'creator'@'%%' identified by 'AaSs12345678^'", i);
    Test->try_query(Test->maxscales->conn_rwsplit[0], "REVOKE SUPER ON *.* FROM 'creator'@'%%'", Test->maxscales->user_name.c_str());
